	...
	<form name="write" method="post" action="<c:url value='/usedGoods/update' />" enctype="multipart/form-data">
          <input type="hidden" value="${usedGoods.g_id }" name="g_id">
				...
				<div class="input-group mb-3" style="width: 45%; float: left; padding: 0px 5px 0px 0px;">
 	 				...
 	 				<input name="price" type="number" value="${usedGoods.price }" class="form-control" placeholder="숫자만 입력해주세요." aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
 	 			</div>               	             	
               	<div class="mb-3">
  		...
  		<button type="button" class="btn btn-outline-danger" style="background-color: #FFE593; border-color: #FFE593;" onclick="location.href='view?g_id=${usedGoods.g_id}'">취소</button>
				</div>
	</form>		
