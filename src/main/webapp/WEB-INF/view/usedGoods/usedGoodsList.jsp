...
<div id="cardList">
	<div class="row row-cols-1 row-cols-md-3 g-4">
		<input type="hidden"/>
		<c:forEach var="usedGoods" items="${goodsList }" varStatus="status">
  				<div class="col">
    				<div class="card h-100" style="width: 330px;">
    					<c:if test="${usedGoods.imageUrl ne null }">
      						...
      						<div class="card-body">
								...
								</svg>${nicknameList[status.index] }</p>
        						...
        						<a href="<c:url value='/usedGoods/view'>
				 				 	...
				 				 	</c:url>" style="background-color: #FFE593; border-color: #FFE593; color: white;" class="btn btn-outline-danger">자세히보기</a>
      						</div>
    					</div>
  				</div>	
  		</c:forEach>
