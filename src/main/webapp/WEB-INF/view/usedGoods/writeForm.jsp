 ...
 <div style="width: 70%; padding: 30px; float: right;">
		    <form name="write" action="<c:url value='/usedGoods/write' />" enctype="multipart/form-data" method="post">
					...
					<div class="input-group mb-3" style="width: 45%; float: left; padding: 0px 5px 0px 0px;">
 	 					...
 	 					<input name="price" type="number" class="form-control" placeholder="숫자만 입력해주세요." aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
 	 				</div>                	                	
                	<div class="mb-3">
  ...
  <br>
  <button type="submit" class="btn btn-danger" style="background-color: #FFE593; border-color: #FFE593; color:white;" type="submit" onClick="usedGoodsCreate()">등록</button>&nbsp;
  <button type="button" class="btn btn-outline-danger" style="background-color: #FFE593; border-color: #FFE593;" onclick="location.href='usedGoodsList'">취소</button>
</div>
                	</form>
